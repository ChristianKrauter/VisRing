...
void example_lineChart() {
  ...
  VisRing.lineChart(values, values_count, false, 0, 0, 3);
  VisRing.displayGS();
  delay(500);
  VisRing.clearDisplayGS(2);
  ...
  VisRing.lineChart(values_3, values_count_3, false, 0, 0, 1);
  VisRing.displayGS();
  delay(500);
  VisRing.clearDisplayGS(2);
  ...
  VisRing.lineChart(values_5, values_count_5, false, 0, 0, 12);
  VisRing.displayGS();
  delay(500);
  VisRing.clearDisplayGS(2);
  ...
  VisRing.lineChart(values_6, values_count_6, false, 0, 0, 5);
  VisRing.displayGS();
  delay(500);
  VisRing.clearDisplayGS(2);
}
